    ...
    class Main(tk.Frame):
        ...
        def create_widgets(self):
            ...
            self.line_button = Button(self.master, text="EXECUTE LINE", command=lambda: self.line_incrementer.set(1), bg="gray", fg="blue", highlightbackground='#008000')
            self.line_button.grid(row=0, column=second_col, columnspan=1, sticky='nswe')
    
            execute_all_button = Button(self.master, text="EXECUTE ALL", command=None, bg="gray", fg="blue", highlightbackground='#008000')
            execute_all_button.grid(row=0, column=third_col, columnspan=1, sticky='nswe')
